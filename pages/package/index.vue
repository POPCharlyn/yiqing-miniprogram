<template>
  <view>
    ...
    <view>
      <button class="book-express" @click="addPackage">预约取件</button>
    </view>
...
import ToExpress from "@/components/Express/ToExpress.vue";

export default {
  name: "index",
  components: {UniCol, UniRow, UniSearchBar, UniCard, ExpressList, ToExpress},
  data() {
    return {
      // tabs 数据源
      tabData: [],
